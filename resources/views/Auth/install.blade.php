    ...
    <div class="d-flex flex-column flex-column-fluid flex-lg-row">
        ...
        <div class="d-flex flex-center w-lg-50 p-10">
            <div class="card w-md-550px">
                <div class="card-body">
                    <form class="form w-100" action="{{ route('install.website.post') }}" method="POST">
                    @csrf
                                       
                                    @if (getDomain() != env('PARENT_SITE'))
                        <div class="text-center mb-4">
                            <h1 class="text-dark fw-bolder">Kích hoạt website</h1>
                            <div class="text-muted fw-semibold fs-6">Xin mời nhập đầy đủ thông tin.</div>
                        </div>
                        ...
                        <div class="row mb-9">
                        <div class="d-grid" >
                            <button type="submit"   style="display:show" class="btn btn-default">Kích hoạt</button>
                        </div>
                        </div>
                    </form>
                </div>
...
<div class="row">
                    <div class="col-lg-12">
                        <div class="text-center p-4">
                            <p class="clearfix mb-0 text-center"> Copyright <a href="javascript:void(0);"
                                    class="text-primary"></a> © 2023. All
                                right
                                reserved.</p>
                        </div>
                    </div>
