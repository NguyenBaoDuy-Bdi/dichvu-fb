    ...
    <div class="d-flex flex-column flex-column-fluid flex-lg-row">
        ...
        <div class="d-flex flex-center w-lg-50 p-10">
            <div class="card w-md-550px">
                <div class="card-body">
                    <form class="form w-100" action="{{ route('reset.password.post', $token->token) }}" method="POST">
                    @csrf
                        <div class="text-center mb-4">
                            <h1 class="text-dark fw-bolder">Đặt mật khẩu mới</h1>
                            <div class="text-muted fw-semibold fs-6">Xin Mời Bạn Điền Thông Tin Vào Bên Dưới.</div>
                        </div>
                        <div class="form-floating mb-5">
                            <input type="password" class="form-control" placeholder="Vui lòng nhập mật khẩu" name="password" value="" />
                            <label for="floatingInput">Mật khẩu mới</label>
                        </div>
                        <div class="form-floating mb-5">
                            <input type="password" class="form-control" id="passwordNewConfirm" placeholder="Vui lòng nhập lại mật khẩu" name="password_confirmation" value="{{ old('password_confirmation') }}" />
                            <label for="floatingPassword">Mật khẩu</label>
                        </div>
                        <div class="row mb-9">
                        <div class="d-grid" >
                            <button type="submit" id="submitLogin" style="display:show" class="btn btn-default">Khôi phục mật khẩu</button>
                        </div>
                        </div>
                        <div class="d-grid">
