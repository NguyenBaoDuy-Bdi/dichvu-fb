                        ...
                        @if (getDomain() == env('PARENT_SITE'))
                            <div class="form-floating mb-3">
                                <select class="form-control border border-info" name="actual_service" placeholder="Name">
                                    ...
                                    <option value="subsieusale" @if ($server->actual_service == 'subsieusale') selected @endif>
                                        subsieusale.com</option>
                                    ...
                                    <option value="muafl" @if ($server->actual_service == 'muafl') selected @endif>Muafl.com</option>
