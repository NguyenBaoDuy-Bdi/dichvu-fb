        ...
        <div class="col-md-12">
            ...
            <div class="card-header ribbon ribbon-start ribbon-clip border-bottom-none min-h-50px">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.order.edit.post', $order->id) }}" method="POST" request="ptl">
                        <div class="form-floating mb-3">
                            <select name="status" id="" class="form-select border border-info">
                                ...
                                <option value="Refunded" @if ($order->status == 'Refunded') selected @endif>Đã hoàn</option>
                                    ...
                                    <option value="PendingOrder" @if ($order->status == 'PendingOrder') selected @endif>Chuẩn bị</option>
                        ...
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control border border-info" value="{{ $order->buff }}" name="buff" rows="5" placeholder="Name">
                            <label><i class="fa fa-star me-2 fs-4 text-info"></i><span
