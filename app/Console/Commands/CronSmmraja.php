...
class CronSmmraja extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'cron:smmraja';
     ...
     * @var string
     */
    protected $description = 'Cron service smmraja';
    ...
    public function handle()
    {
        ...
        $this->info('Cron smmraja: ' . date('d-m-Y H:i:s'));
        $data = Orders::where('actual_service', 'smmraja')
        ...
        $this->info('Cron smmraja: ' . $count . ' orders');
