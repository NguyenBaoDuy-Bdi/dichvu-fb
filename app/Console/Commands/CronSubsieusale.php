...
class CronSubsieusale extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'cron:subsieusale';
     ...
     * @var string
     */
    protected $description = 'Cron service subsieusale';
    ...
    public function handle()
    {
        ...
        $this->info('Cron Subsieusale: ' . date('d-m-Y H:i:s'));
        $data = Orders::where('actual_service', 'subsieusale')
        ...
        $this->info('Cron Subsieusale: ' . $count . ' orders');
