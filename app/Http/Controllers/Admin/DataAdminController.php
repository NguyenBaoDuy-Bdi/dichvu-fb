...
public function rechargeCard(Request $request)
    ...
    public function rechargeConfig(Request $request)
    {
        ...
        $valid = Validator::make($request->all(), [
          'type' => 'required|string|in:mbbank,vietcombank,momo,acb,tpbank',
               ...
               return resApi('success', 'Cập nhật thành công');
                ...
                switch ($request->type) {
                    case 'mbbank':
                        ...
                        break;
                    case 'tpbank':
                        $logo = '/assets/images/bank/tpbank.jpg';
                        $qr = "https://img.vietqr.io/image/" . 'tpbank-' . $request->stk . '-compact2.jpg?amount=10000&accountName=' . $request->name;
                        break;
                    case 'vietcombank':
                        $bank = 'Vietcombank';
