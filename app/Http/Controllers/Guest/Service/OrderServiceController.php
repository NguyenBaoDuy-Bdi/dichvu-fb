...
use App\Http\Controllers\Api\Serivce\SmmrajaController;
                                                ...
                                                if ($user->balance < $total_payment) {
                                                    ...
                                                    if (env('IS_ORDER') == true) {
                                                        ...
                                                        if ($server->actual_service == 'subgiare') {
                                                            ...
                                                            if ($result['status'] == true) {
                                                                ...
                                                                if ($order) {
                                                                    ...
                                                                    'ip' => $request->ip(),
                                                                    'dongia' => number_format($total_payment),
                                                                    'linkorder' => $request->link_order,
                                                                    'maychu' => $request->server_service,
                                                        ...
                                                        elseif ($server->actual_service == 'subsieusale') {
                                                            $subsieusale = new SubsieusaleController();
                                                            ...
                                                            $result = $subsieusale->CreateOrder();
                                                            if ($result['status'] == true) {
                                                                $order_history[] = [
                                                                    'time' => Carbon::now()->format('H:i d/m/Y'),
                                                                    'status' => 'info',
                                                        ...
                                                        elseif ($server->actual_service == 'smmraja') {
                                                            $smmraja = new SmmrajaController();
                ...
                if ($user) {
                    ...
                    if ($valid->fails()) {
                        ...
                        if ($admin) {
                            ...
                            return response()->json([
                                'status' => 'error',
                                'message' => 'Bên tài khoản site mẹ hết tiền vui lòng nạp thêm tiền!'
                            ]);
                        }
                    }
                } else {
