...
{
    public $email = "mabuhoang9@gmail.com"; //email tài khoản cloudflade
    public $global_key = "4c1b2a9f15506755ba3a46d0c8383ea46c19d"; //api key lấy từ https://dash.cloudflare.com/profile/api-tokens
    public $account_id = "b384c30e61282cb028727814b117c7b9"; // account id lấy click vào doamin rồi kéo xuống tìm acccount id
    public $token = "eRmEyyTcczbSCpgAHZZ4GxnSTklwN0YiVR-h_cGK"; //tạo token từ https://dash.cloudflare.com/profile/api-tokens
    public $ip_host = "103.200.23.126"; // ip của hosting
