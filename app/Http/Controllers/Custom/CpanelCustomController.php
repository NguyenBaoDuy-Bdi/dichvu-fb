...
{
    private $cpanel_server = "link host"; // link host: VD: https://web07.vn-server.com:2083/cpsess3957128501/
    private $username_cpanel = "hello"; //username cpanel
    private $password_cpanel = "mk host"; //password cpanel
